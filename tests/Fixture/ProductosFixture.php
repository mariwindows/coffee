...
class ProductosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'prod_img' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'prod_img' => 'Lorem ipsum dolor sit amet',
            'dir' => 'Lorem ipsum dolor sit amet',
            'precio' => 1.5,
            'created' => '2016-11-16 20:46:02',
            'modified' => '2016-11-16 20:46:02'
        ],
    ];
}
